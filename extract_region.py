...
if __name__ == "__main__":
    ...
    train_set, test_set = train_test_split(entire_region, test_size=0.1, random_state=42)
    ...
    for index, split in enumerate(list):
        ...
        json.dump(input_to_id, open(os.path.join(outfile, "input_to_id.json"), "a"))
        json.dump(id_to_output, open(os.path.join(outfile, "id_to_output.json"), "a"))
